...
We will also call cropped selections from takes \emph{Regions} but will treat them
...
rating -- this is the \emph{Dashboard} in which to play around and choose the finally
used regions.
...
\paragraph{Note:}
The \emph{Transition Editor} will provide a crossfade editor to fine-tune the
transition.
