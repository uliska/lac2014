...
It's easy to accidentally break something when editing a file.  If you save
such modified version, overwriting previous one, you're in trouble.
...
Ths is magnified by opaqueness of binary files: your program is doing something
with them, but you cannot see what exactly changed.
...
All this prevents you from experimenting freely.

\subsection{There's a Lot on Your Head}
You surely have a long \textsc{todo} list -- checking whether the issues were resolved
is tedious.
...
What's wrong, your critical notes and \textsc{todo}s are separated from the actual content --
...
Plain text and version control may be intimidating and seem “nerdy”,
but they offer substantial advantages over \textsc{wysiwyg}
approaches. 
...
% Add this somewhere:
% you can iterate at incredible pace - talk in chat and work on the same document
% simultaneously, updating your versions every 5 minutes, no sweat!
