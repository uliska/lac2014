...
\section{The Problem}
So, what exactly is wrong with current music editing tools and workflows?  Well, several things:

\subsection{You Have To Be Careful}
opaqueness of binary files
easy to miss changes
safety and cheapness of experimenting
...
inconsistent states of work  -> branches

\subsection{Your Workflow Isn't Flexible}
music entry must be done in order
...
not easy to create multiple versions
...
In the rest of the paper we explain in detail how all this works.
