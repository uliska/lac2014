...
the preparation of scholarly editions and allowing completely new approach to music
publishing.
...
\keywords{
\begin{contentsmall}
Musica engraving, music publishing, scholarly editions, version control, workflows.
\end{contentsmall}
}
...
It's easy to accidentally break something. If you're working in a team you may run
into having multiple parallel versions of files and risking to overwrite good files
with bad ones.  This problem is magnified by opaqueness of binary files and \textsc{gui}
...
Maybe you're working in a team and you'd like to do some edits, but you have to wait
until your colleague finishes his part and “unlocks” the files for you.
...
In order to benefit from versioned
